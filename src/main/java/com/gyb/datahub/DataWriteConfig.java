...
@Component
public class DataWriteConfig {
    @Value("${datahub2.clients.default.accessId}")
    private String accessId;
    @Value("${datahub2.clients.default.accessKey}")
    private String accessKey;
    @Value("${datahub2.clients.default.endpoint}")
    private String endpoint;

    @Value("${datahub2.topics.project}")
    private String projectName;
    @Value("${datahub2.topics.topic1}")
    private String topicName1;
    @Value("${datahub2.topics.topic2}")
    private String topicName2;
    @Value("${datahub2.topics.topic3}")
